...
EJitCodePoolMemoryManager::EJitCodePoolMemoryManager(
    EJitCodePoolManager &NearPool, EJitCodePoolManager &FarPool,
    size_t PageSize, PoolSelector ColdSelector, ColdRangeRecorder RecordCold)
    : NearPool_(NearPool), FarPool_(&FarPool),
      ColdSelector_(std::move(ColdSelector)), RecordCold_(std::move(RecordCold)),
      PageSize_(PageSize) {}
